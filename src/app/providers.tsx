            ...
            <DialogContent className="sm:max-w-md">
                ...
                <div className="prose prose-sm max-h-60 overflow-y-auto pr-4 text-sm text-muted-foreground">
                    ...
                    <ul className="list-disc space-y-2">
                        ...
                        <li><strong>सेवाओं का विस्तार और रखरखाव:</strong> भविष्य में ऐप की गुणवत्ता बनाए रखने, सर्वर के खर्चों या नई सुविधाओं (जैसे स्मार्ट नोट्स, AI सारांश, और ऑफलाइन एक्सेस) को जोड़ने के लिए, ऐप में तृतीय-पक्ष सेवाओं (Third-party services) या प्रमोशनल कंटेंट का समावेश किया जा सकता है। यह उपयोगकर्ताओं के लिए ऐप को 'फ्री' रखने में सहायक होगा।</li>
